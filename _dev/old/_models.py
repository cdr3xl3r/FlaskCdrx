...
from sqlalchemy import ForeignKey,text,CHAR,DATE, Boolean
...
class User(Base,UserMixin):# User base class
...
class Line(Base):# Class Line(Line in Ledger): the lines populated in the ledger
    ...
    deb_Cred:Mapped[bool] = mapped_column(Boolean,nullable=False,default=True)
